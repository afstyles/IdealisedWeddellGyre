MODULE usrdef_hgr
   ...
   !USE usrdef_nam, ONLY: rn_dx, rn_dy, rn_0xratio, rn_0yratio, rn_ppgphi0, nn_fcase, rn_sponge_lx
...
CONTAINS
   ...
   SUBROUTINE usr_def_hgr( plamt , plamu , plamv  , plamf  ,   &   ! geographic position (required)
      ...
      !                          ==========
      !zlam0 = REAL( (-NINT(jpiglo*rn_0xratio)-1) * rn_dx - rn_sponge_lx, wp)
      
      zlam0 = REAL( -rn_chan_lx, wp )
